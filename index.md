...
**徐正文徐老师** 是我对 科技产生兴趣的 启蒙老师，小学后三年，（我在一个 一不听话或者莫名其妙 被挨打的封建家庭中），**徐老师是我的精神源泉**，他一直鼓励着我。我甚至旷课，整天跑到他那里去。
我参加了许许多多的科技活动，还绞尽脑汁搞发明。**成就感是我的第二个精神源泉**


#### Discuz!小小开发者一枚
![](static/img/discuz.png)
*//就当是写自传了,好久都没有回忆起这些了，好怀念QAQ*
**6年级（2011年）** 的时候便萌发出了建立论坛的想法
...
（PS:用到什么就学什么，当初甚至连`jQuery`都用上了，js中对`Cookie`的操作还是一知半解）
...
时间快的不得了。
- - -
不说了，乱七八糟说了一堆还好想哭，现在是 **22:58 2017.10.13 星期五**，该睡觉了。
...
百度一搜 马上搞到。
小学的时候，除了论坛
我还遇到了一个叫[我爱秘籍](http://bbs.52miji.com/forum.php)的网站，和我学前后端的套路一样。
...
很想加入。
我7月份认识了周易、认识了方启腾、认识了常俊飞、又认识了马玉珍学姐，8月份认识了陈曦，9月份又认识了杨青霖。
这份喜欢催促着我不断去了解他们。
...
**周易**给我的感觉和**徐老师**、**弘树**一样吧，我问啥弱智问题都详细解答。还自带萌萌哒表情包233333333333
托他的福，我**了解**了点`Hexo`（因为他博客是这玩意儿搭的）
**学着用了**那个超简洁的Markdown编辑器`Typora`
**知道**了`vue-cli`是啥子（脚手架）
**翻了翻**那个新的[多火官网](www.duohuo.org) 搜了`mainifest.js` `vendor.js` `app.js`是啥子
...
**题外话**
其实一开始我是抗拒`Markdown`的，去年我就知道有这个东西，知乎上面一堆人鼓吹  怎么怎么牛了,作家必备之类 的话。给我感觉是恶心的...
...
- 不能复制粘贴时保存原有css样式
- 弄表格很慢、语法复杂的很
- 我经常忘记`链接`和`插入图片`的语法中的括号顺序是`[]()`而不是`()[]`
- 以后再说....

平时我笔记都是记在`为知笔记`里面的。
GUI编辑器有它的巨大好处。
我觉得最大的好处是：能复制粘贴 Html 自带的样式而毫不改变。
写作的话以后我肯定会力推`Markdown`
